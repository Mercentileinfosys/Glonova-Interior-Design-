...
export default function Footer() {
  ...
  const socialLinks = [
    { icon: Facebook, href: 'https://www.facebook.com/Glonovainteriordesign', label: 'Facebook' },
    { icon: Instagram, href: 'https://www.instagram.com/glonovainteriordesign/', label: 'Instagram' },
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <p className="text-warmGrey-light text-sm leading-relaxed mb-6 max-w-sm">
                Glonova Pte Ltd is a Singapore-based manufacturing and interior solutions company specializing in doors, windows, and complete interior renovation needs. We transform spaces with innovative designs and lasting quality from concept to completion.
              </p>
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex items-center gap-3 text-warmGrey-light text-sm">
                  ...
                  <a href="tel:+6581152385" className="hover:text-metallic-gold transition-colors">
                    +65 8115 2385
                  </a>
                </div>
                <div className="flex items-center gap-3 text-warmGrey-light text-sm">
                  ...
                  <a
                    href="mailto:Enquiries@glonovas.com"
                    className="hover:text-metallic-gold transition-colors"
                  >
                    Enquiries@glonovas.com
                  </a>
                </div>
              </div>
